app.controller('DetailAttendanceController', function($scope, $http, API,$timeout){	
	...
	$scope.getAttendance = function(id){
		...
		var url= API + 'managersites/check-attendance/detailattendancejson/'+id;
		console.log(url);
	...
	$scope.getCourseStudentList = function(id){
		var url = API + 'managersites/check-attendance/coursestudentslistjson/'+id;
		console.log(url);
		$http.get(url).then(function successCallback (response){
	...
	$scope.lockAttendance = function(id){
		var url = API + '/managersites/check-attendance/lockattendancejson/'+id;
		console.log(url);
	...
	$scope.getListStudentDebts = function(id){
		var url = API + 'managersites/check-attendance/liststudentsdebtjson/'+id;
		console.log(url);
		$http.get(url).then(function successCallback (response){
	...
	var detailStudent = function(id){
		var url = API + 'managersites/student/detailjson/'+id;
		var url;
		console.log(url);
		$http.get(url).then(function successCallback (response){
	...
	var getListDebtOfStudent = function(studentId){
		var url = API + 'managersites/debt/debtofstudentjson/'+studentId;
		console.log(url);
