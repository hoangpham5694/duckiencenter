...
@section('header')
<title>Admin::Chi tiết thanh toán</title>
@endsection
@section('title')
...
<div class="col-sm-4">
  <a class="btn pull-right"  target="_blank" href="{!! url('adminsites/payout/bill')!!}/{!! $payout->id !!}" ><i class="fa fa-print" aria-hidden="true"></i> In hóa đơn</a>
