...
@section('header')
    <title>Học viên::Danh sách lớp học</title>
@endsection
@section('title','Danh sách lớp học')
@section('content')
<div ng-controller="CourseController">
        <div class="row" data-ng-init="getListTeachers(); getListAgencies(); setMethod('{!! $method !!}')">
          {% name%}
        <div class="col-sm-4">
                              ...
                              <thead>
                                ...
                                <tbody>
                                	<tr ng-repeat="course in courses">
                                		...
                                		<td>
                                            <a class="btn btn-xs btn-primary" ng-href="{!! url('studentsites/course/detail') !!}/{% course.id %}">
