...
@section('header')
<title>Manager::Chi tiết Hóa đơn</title>
@endsection
@section('title')
...
<div class="col-sm-4">
  <a class="btn pull-right"  target="_blank" href="{!! url('managersites/payin/bill')!!}/{!! $payin->id !!}" ><i class="fa fa-print" aria-hidden="true"></i> In hóa đơn</a>
