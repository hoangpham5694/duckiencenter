...
@section('header')
    <title>Manager::Danh sách Học viên</title>
@endsection
                              ...
                              <thead>
                                ...
                                <tbody>
                                	<tr ng-repeat="student in students">
                                		...
                                		<td>
                                      <a class="btn btn-xs btn-primary" ng-href="{!! url('managersites/student/detail') !!}/{% student.id %}">
                                        <i class="fa fa-address-card" aria-hidden="true"></i> Chi tiết
                                      </a>

                                      <a class="btn btn-xs btn-primary" ng-href="{!! url('managersites/student/edit') !!}/{% student.id %}">
...
@endsection
@section('footer')
  <script src="<?php echo asset('public/app/controller/managers/StudentController.js') ; ?>"></script>  
@endsection
