...
@section('header')
    <title>Manager::Kiểm tra buổi học</title>
@endsection
                                ...
                                <tbody>
                                	<tr ng-repeat="attendance in attendances" ng-class="{warning: attendance.is_taught ==0 , success:attendance.is_taught ==1} ">
                                     ...
                                     <span ng-if="attendance.is_taught ==1">Đã học</span>
                                		...
                                		<td>
                                            <a class="btn btn-xs btn-primary" ng-href="{!! url('managersites/check-attendance/detail') !!}/{% attendance.id %}">
...
@endsection
@section('footer')
  <script src="<?php echo asset('public/app/controller/admins/CheckAttendanceController.js') ; ?>"></script>  
@endsection
