                              ...
                              <thead>
                                ...
                                <tbody>
                                    <tr ng-repeat="student in students">
                                        ...
                                        <td></td>
                                        <td>
                                            <a class="btn btn-xs btn-primary" ng-href="{!! url('managersites/student/detail') !!}/{% student.student_id %}">
                                                <i class="fa fa-address-card" aria-hidden="true"></i> Chi tiết
                                            </a>
    <button class="btn btn-danger btn-xs btn-delete" ng-click="confirmDelete(student.id)">  <i class="fa fa-trash" aria-hidden="true"></i> Xóa</button>
                                          </td>
                                    </tr>
                                </tbody>
</table>
...
@section('footer')
  ...
  <script src="<?php echo asset('public/app/controller/managers/CourseStudentController.js') ; ?>"></script>  
