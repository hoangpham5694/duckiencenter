...
@section('header')
    <title>Manager::Danh sách giáo viên</title>
@endsection
                              ...
                              <thead>
                                ...
                                <tbody>
                                	<tr ng-repeat="teacher in teachers">
                                		...
                                		<td>
                                      <a class="btn btn-xs btn-primary" ng-href="{!! url('managersites/teacher/detail') !!}/{% teacher.id %}">
...
@endsection
@section('footer')
  <script src="<?php echo asset('app/controller/managers/TeacherController.js') ; ?>"></script>  
@endsection
